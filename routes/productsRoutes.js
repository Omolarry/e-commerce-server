...
router.get("/all-products", productController.getAllProduct);//frontend
router.get("/all-products", productController.getAllProducts);//backend
...
router.post("/product-by-popularity", productController.getProductByPopularity);
...
router.post("/single-productId", productController.getSingleProductId);
router.post("/single-productName", productController.getSingleProductName);
